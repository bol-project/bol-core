...
namespace Bol.Api.Services
{
    ...
    {
        InvocationTransaction DeployContract(byte[] script, string name, string version, string author, string email, string description, IEnumerable<KeyPair> keys, int numberOfSignatures = 0);
        InvocationTransaction InvokeContract(string contract, string operation, IEnumerable<byte[]> parameters, string description = null, IEnumerable<string> remarks = null, IEnumerable<KeyPair> keys = null, int numberOfSignatures = 0);
        void InvokeContract(InvocationTransaction transaction);
        ContractExecutionResult TestContract(string contract, string operation, IEnumerable<byte[]> parameters, string description = null, IEnumerable<string> remarks = null, IEnumerable<KeyPair> keys = null, int numberOfSignatures = 0);
        ContractExecutionResult TestContract(InvocationTransaction transaction);
        InvocationTransaction CreateTransaction(string contract, string operation, IEnumerable<byte[]> parameters, string description = null, IEnumerable<string> remarks = null, IEnumerable<KeyPair> keys = null, int numberOfSignatures = 0);
